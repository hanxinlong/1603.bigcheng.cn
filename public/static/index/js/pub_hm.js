(function () {
    var h = {}, mt = {}, c = {
        id: "88ab8b291a27492cc500a195d5239d22",
        dm: ["douguo.com"],
    ...
    var r = void 0, s = !0, t = null, w = !1;
    mt.h = {};
    mt.h.xa = /msie (\d+\.\d+)/i.test(navigator.userAgent);
    mt.h.va = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : r;
    mt.h.cookieEnabled = navigator.cookieEnabled;
    mt.h.javaEnabled = navigator.javaEnabled();
    mt.h.language = navigator.language || navigator.browserLanguage || navigator.systemLanguage || navigator.userLanguage || "";
    mt.h.za = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    mt.h.colorDepth = window.screen.colorDepth || 0;
    mt.cookie = {};
    mt.cookie.set = function (a, b, d) {
        var e;
        d.G && (e = new Date, e.setTime(e.getTime() + d.G));
        document.cookie = a + "=" + b + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (e ? "; expires=" + e.toGMTString() : "") + (d.Sa ? "; secure" : "")
    };
    ...
    (mt.m.M = function () {
        ...
        (function () {
            if (!d)if (d = s, "complete" === document.readyState)a.B = s; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
            ...
            switch (typeof e) {
                ...
                default:
                    ...
                    if (e instanceof Array) {
                        var d = ["["], l = e.length, n, f, k;
                        for (f = 0; f < l; f++)switch (k = e[f], typeof k) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                            default:
                                n && d.push(","), d.push(mt.j.stringify(k)), n = 1
                        }
                        d.push("]");
                        return d.join("")
                    }
                    ...
                    n = ["{"];
                    f = mt.j.stringify;
                    for (l in e)if (Object.prototype.hasOwnProperty.call(e, l))switch (k =
                        e[l], typeof k) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    mt.localStorage.set = function (a, b, d) {
        ...
        try {
            window.localStorage ? (b = e.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.D() && (mt.localStorage.f.expires = e.toUTCString(), mt.localStorage.f.load(document.location.hostname), mt.localStorage.f.setAttribute(a, b), mt.localStorage.f.save(document.location.hostname))
        } catch (g) {
        }
    };
    ...
    var A = h.ia;
    h.p = {
        Oa: "http://tongji.baidu.com/hm-web/welcome/ico",
        ...
        Ga: 1,
        w: 2147483647,
        Y: "cc cf ci ck cl cm cp cu cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api u tt".split(" ")
    };
    (function () {
        var a = {
            l: {}, c: function (a, d) {
                ...
                this.l[a] = this.l[a] || [];
                for (var e = this.l[a].length, g = 0; g < e; g++)this.l[a][g](d)
            }
        };
        return h.r = a
    })();
    ...
    (function () {
        var a = mt.m, b = h.p, d = h.load, e = h.P;
        h.r.c("pv-b", function () {
            c.rec && a.M(function () {
                for (var g = 0, l = c.rp.length; g < l; g++) {
                    var n = c.rp[g][0], f = c.rp[g][1], k = a.Q("hm_t_" + n);
                    if (f && !(2 == f && !k || k && "" !== k.innerHTML))k = "", k = Math.round(Math.random() * b.w), k = 4 == f ? "http://crs.baidu.com/hl.js?" + ["siteId=" + c.id, "planId=" + n, "rnd=" + k].join("&") : "http://crs.baidu.com/t.js?" + ["siteId=" + c.id, "planId=" + n, "from=" + e(), "referer=" + encodeURIComponent(document.referrer), "title=" + encodeURIComponent(document.title), "rnd=" +
                    k].join("&"), d(k)
                }
            })
        })
    ...
    (function () {
        var a = h.p, b = h.load, d = h.P;
        h.r.c("pv-b", function () {
            if (c.trust && c.vcard) {
                var e = a.protocol + "//trust.baidu.com/vcard/v.js?" + ["siteid=" + c.vcard, "url=" + encodeURIComponent(document.location.href), "source=" + d(), "rnd=" + Math.round(Math.random() * a.w), "hm=1"].join("&");
                b(e)
            }
        })
    })();
    (function () {
        ...
        function b() {
            ...
            if ((!n || !k) && f && m)u = s, p = +new Date; else if (n && k && (!f || !m))u = w, q += +new Date - p;
            n = f;
            k = m;
            y = setTimeout(b, 100)
        }
        ...
        function d(a) {
            var k = document, p = "";
            if (a in k)p = a; else for (var b = ["webkit", "ms", "moz", "o"], q = 0; q < b.length; q++) {
                var d = b[q] + a.charAt(0).toUpperCase() + a.slice(1);
                if (d in k) {
                    p =
                        d;
                    break
        ...
        var g = mt.event, l = h.r, n = s, f = s, k = s, m = s, v = +new Date, p = v, q = 0, u = s, x = d("visibilityState"), z = d("hidden"), y;
        b();
        (function () {
    ...
    (function () {
        var a = mt.lang, b = h.p, d = h.load, e = {
            wa: function (e) {
    ...
    (function () {
        function a(k) {
            for (var b in k)if ({}.hasOwnProperty.call(k, b)) {
                var e = k[b];
                d.d(e, "Object") || d.d(e, "Array") ? a(e) : k[b] = String(e)
            }
        }
        ...
        var d = mt.lang, e = mt.j, g = h.p, l = h.r, n = h.da, f = {
            s: [], C: 0, U: w, init: function () {
                f.e = 0;
                l.c("pv-b", function () {
                    f.ea();
                    f.ga()
                ...
                if (!a || d.d(a, "Array"))window._hmt = {
                    id: c.id, cmd: {}, push: function () {
                        for (var a = window._hmt, k = 0; k < arguments.length; k++) {
                            var p = arguments[k];
                            d.d(p, "Array") && (a.cmd[a.id].push(p), "_setAccount" === p[0] && (1 < p.length && /^[0-9a-f]{32}$/.test(p[1])) && (p = p[1], a.id = p, a.cmd[p] = a.cmd[p] || []))
                        }
                    }
                }, window._hmt.cmd[c.id] = [], window._hmt.push.apply(window._hmt, a)
            }, ga: function () {
                var a = window._hmt;
                if (a && a.cmd && a.cmd[c.id])for (var b = a.cmd[c.id], e = /^_track(Event|MobConv|Order|RTEvent)$/, p = 0, q = b.length; p < q; p++) {
                    var d = b[p];
                    e.test(d[0]) ? f.s.push(d) : f.L(d)
                }
                a.cmd[c.id] = {push: f.L}
            }, ha: function () {
                ...
                var b = a[0];
                if (f.hasOwnProperty(b) && d.d(f[b], "Function"))f[b](a)
            }, _setAccount: function (a) {
                1 < a.length && /^[0-9a-f]{32}$/.test(a[1]) && (f.e |= 1)
            }, _setAutoPageview: function (a) {
                if (1 < a.length && (a = a[1], w === a || s === a))f.e |= 2, h.b.T = a
                ...
                1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? g.protocol + "//" + window.location.host + a[1] : a[1], f.U = s)
            }, _trackOrder: function (b) {
                b = b[1];
                d.d(b, "Object") && (a(b), f.e |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = e.stringify(b), h.b.g())
                ...
                b = b[1];
                d.d(b, "Object") && (a(b), b = e.stringify(b), 512 >= encodeURIComponent(b).length && (f.e |= 64, h.b.a.rt = b))
            }, _trackRTEvent: function (b) {
                b = b[1];
                if (d.d(b, "Object")) {
                    a(b);
                    b = encodeURIComponent(e.stringify(b));
                    var m = function (a) {
                        var b = h.b.a.rt;
                        f.e |= 128;
                        h.b.a.et = 90;
                    ...
                    if (900 >= l)m.call(this, b); else for (var l = Math.ceil(l / 900), p = "block|" + Math.round(Math.random() *
                            g.w).toString(16) + "|" + l + "|", q = [], u = 0; u < l; u++)q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), m.call(this, p + q.join("|")), q = []
                }
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.T = s, this.I = w, this.init())
        }

        var b = mt.url, d = mt.X, e = mt.O, g = mt.lang, l = mt.cookie, n = mt.h, f = mt.localStorage, k = mt.sessionStorage, m = h.p, v = h.r;
        a.prototype = {
            J: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a =
                    w;
                this.A(document.referrer) && this.A(document.location.href) ? a = s : (a = b.S(document.referrer), a = this.J(a || "", document.location.hostname));
                ...
                try {
                    l.set(a, b, {domain: this.H(), path: this.R(), G: d}), d ? f.set(a, b, d) : k.set(a, b)
                } catch (e) {
                }
            }, ya: function (a) {
                try {
                    l.set(a, "", {domain: this.H(), path: this.R(), G: -1}), k.remove(a), f.remove(a)
                } catch (b) {
                }
            }, Da: function () {
                var a, b, d, e, f;
                ...
                for (var a = [], b = this.a.et, d = 0, e = m.Y.length; d < e; d++) {
                    var f = m.Y[d], g = this.a[f];
                ...
                this.a.cm = b.i(a, m.sa) || "";
                this.a.cp = b.i(a, m.ta) || "";
                this.a.cw = b.i(a, m.ra) || "";
                this.a.ci = b.i(a, m.pa) || "";
                this.a.cf = b.i(a, m.ua) || "";
                this.a.cu = b.i(a, m.qa) || ""
            }, init: function () {
                try {
                    this.Ea(),
                        0 === this.a.nv ? this.Ba() : this.N(".*"), h.b = this, this.ca(), v.z("pv-b"), this.Aa()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                this.T ? (this.I = s, this.a.et = 0, this.a.ep = "", this.g(a)) : a()
            }, g: function (a) {
                var b = this;
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(m.aa), f = b.i(a, "jn"), g = /^heatlink$|^select$/.test(f);
            ...
            Ba: function () {
                ...
                if (b)for (var b = b.split(","), e = function (b) {
                    d.log(m.K + "//" + decodeURIComponent(b), function (b) {
                        a.N(b)
                    })
    ...
    (function () {
        var a = mt.m, b = mt.event, d = mt.url, e = mt.j;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var f = function () {
                    ...
                    a = document.referrer;
                    var k = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [], u = t;
                    b = t;
                    if ("www.baidu.com" === k[2] || "m.baidu.com" === k[2])u = d.i(a, "qid"), b = d.i(a, "click_t");
                    a = u;
                    f.qid = a != t ? a : "";
                    b != t ? (f.bdDom = n ? n - b : 0, f.bdRun = g - b, f.bdDef = l("navigation").start - b) : (f.bdDom = 0, f.bdRun = 0, f.bdDef = 0);
                    h.b.a.et = 87;
    ...
    (function () {
        var a = mt.h, b = mt.lang, d = mt.event, e = mt.j;
        if ("undefined" !== typeof h.b && (c.med || (!a.xa || 7 < a.va) && c.cvcc)) {
            var g, l, n, f, k = function (a) {
                ...
                f.v = a;
                if (d) {
                    var l = d.getAttribute("href"), k = d.getAttribute("onclick") ? "" + d.getAttribute("onclick") : t, m = d.getAttribute("id") || "";
            ...
            if ("undefined" !== typeof f && "undefined" !== typeof n) {
                ...
                var u = function (a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList"))for (var e = 0, f = d.length; e < f; e++)if (q === d[e])return v(l + a + "/" + (e + 1), d[e]), w
                };
    ...
    (function () {
        var a = mt.m, b = mt.lang, d = mt.event, e = mt.j;
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                Z: function () {
                    for (var b = c.cvcf.length, e, f = 0; f < b; f++)(e = a.Q(decodeURIComponent(c.cvcf[f]))) && d.c(e, "click", g.fa())
                }, fa: function () {
                    return function () {
                        h.b.a.et = 86;
                        var a = {n: "form", t: "clk"};
