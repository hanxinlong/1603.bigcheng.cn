try {
    !function () {
        ...
        var e = {global: t, proxyName: !1, basePath: "https://cpro.baidustatic.com/cpro/ui/dup/"};
        !function () {
            var i = {
                name: "oojs", namespace: "", classes: {}, noop: function () {
                    ...
                    if ("object" != typeof t) {
                        if (e)for (var n = t.split("."), o = 0, r = n.length; r > o; o++) {
                            ...
                            i[s] = i[s] || {pathValue: i.pathValue}, i = i[s]
                        } else e = t;
        ...
        i.setPath("https://dup.baidustatic.com/"), i.define({
            ...
            painterName: "static",
            assert: function (t) {
                var e = t.pdb_deliv, i = e.deliv_des;
            ...
            $config: function () {
                this.HTTP_PROTOCOL = "https:" === location.protocol ? "https:" : "http:", i.global.userConfig && i.global.userConfig.domain && (this.REQUEST_URL_CNAME = i.global.userConfig.domain || "")
            }
        }), i.define({
            name: "lang",
            ...
            load: function (t, e, n) {
                var o = i.getClassPath(e), r = this.check(o);
                if (!r) {
                    ...
                    d.parentNode.insertBefore(s, d), this.loadingCls[t] = n
                }
            },
            check: function () {
            ...
            name: "monitor", namespace: "dup.business", sendLog: function (t) {
                if (t.response) {
                    var e = t.response.pdb_deliv.deliv_des, i = e._html, n = i && i.monitorUrl;
                    if (n) {
                        var o = new Image, r = "log" + +new Date;
            ...
            getQueryValue: function (t, e, i) {
                var n = new RegExp("(\\?|&|#)" + e + "=([^&#]*)(&|#)?"), o = t.match(n), r = "";
            ...
            getMainDomain: function (t) {
                t = t || document.domain,
                0 === t.indexOf("www.") && (t = t.substr(4)), "." === t.charAt(t.length - 1) && (t = t.substring(0, t.length - 1));
            ...
            paramsList: [{
                ...
                key: "ltu", encode: !0, limit: 700, value: function () {
                    ...
                    return e = t.location && t.location.href ? t.location.href : this.url.getTopWindowUrl(n), e.indexOf("cpro_prev") > 0 && (e = e.slice(0, e.indexOf("?"))), e
                }
            }, {
                ...
                key: "lcr", encode: !0, value: function () {
                    ...
                    var t = this.doc.referrer, e = t.replace(/^https?:\/\//, "");
            ...
            assert: function (t) {
                for (var e = t.response.placement.userdefine || "", i = e.split("|"), n = {}, o = 0, r = i.length; r > o; o++) {
                    var s = i[o], a = s.split("="), d = a[0];
                    d && (n[d] = a[1])
                }
                if (n.hasOwnProperty("painter"))return n.painter;
                var l = t.styleOpenApi.tn || "", c = parseInt(t.styleOpenApi.xuanting || 0, 10);
            ...
            $sceneTactics: function () {
                this.config.REQUEST_URL_CNAME && this.browser.antBrowser && (this.config.REQUEST_URL = "//" + this.config.REQUEST_URL_CNAME + "/", this.config.IS_CNAME = !0);
            ...
            validate: function (t, e, i, n, o) {
                var r = !1, s = this.getPrevValue(i, o);
                if (!s)return r;
            ...
            onPostMessageHandler: function (t) {
                if ("object" == typeof t && t.data) {
                    ...
                    if ("string" == typeof e && !(e.indexOf(this.expansionActionName) < 0)) {
                        ...
                        o.position = "fixed", o.left = "0", o.top = n + "px", o.zIndex = 2147483647, o.background = "#ffffff", o.width = "100%", o.transition = o.WebkitTransition = o.MozTransition = o.OTransition = "top 1s ease-in-out", e = e.slice(this.expansionActionName.length);
                        ...
                        this.expandContainerEl.innerHTML = this.lang.template(r, a), this.expandContainerEl.style.top = "0", document.body.appendChild(this.expandContainerEl), this.dom.bind(window, "resize", i.proxy(this, this.onResizeHandler));
            ...
            render: function (t) {
                ...
                this.dockTo = parseInt(o.location, 10) || this.BOTTOM, this.adWrapEl = document.getElementById(t.containerId), this.adWrapEl.style.display = "block", this.adIframe = this.dom.g(t.containerId + "_frame");
                var r = this.dom.g(t.containerId + "_closebtn"), s = parseInt(this.adWrapEl.style.height || t.height, 10), a = parseInt(r.style.height, 10);
                this.hiddenHeight = -1 * (s + a), this.haveSetIframeUrl = !0, this.countDownTimerId = !1, this.close4ever = !1, this.shrinkAd(), this.transitionDecorator(this.adWrapEl), this.lastScrollTop = this.style.getScrollTop(), this.dom.bind(r, "click", i.proxy(this, this.closeBtnOnClickHandler)), this.dom.bind(window, "scroll", i.proxy(this, this.onScrollHandler))
            },
            validate: function (t) {
            ...
            onScrollHandler: function () {
                ...
                this.totalScrollLength += e - this.lastScrollTop, this.lastScrollTop = e, "top" === n && !this.close4ever && Math.abs(this.totalScrollLength) >= t && !this.countDownTimerId ? (this.expandAd(), this.startCountDown(this.autoCloseTime, i.proxy(this, this.onTimeCountDownHandler))) : "down" === n && (this.totalScrollLength = 0)
            },
            ...
            getPainter: function (t) {
                ...
                for (var n = t.response, o = ["dan.static", "dan.couplet", "dan.expand", "dan.barrier", "dan.video", "topSearchBar", "bottomSearchBar", "slide", "inlayFix", "baiduRec", "dynamicFloat", "float", "insideText", "mobile.inlayFix", "mobile.float"], r = 0, s = o.length; s > r; r++) {
                    var a = i.using("dup.ui.assertion." + o[r]);
                    if (a && a.assert(n))return "dup.ui.painter." + o[r]
                }
                return e || (t.errors = t.errors || [], t.errors.push("painterName is empty")), "dup.ui.painter.inlayFix"
            }
        }), i.define({
            name: "businessParam",
            namespace: "dup.business.parameter",
            ...
            snap: function (t) {
                for (var e = [], i = t.paramsList, n = 0, o = i.length; o > n; n++) {
                    var r = i[n], s = r.key, a = r.encode, d = r.value, l = r.limit;
                    try {
            ...
            processExtendsParam: function (t) {
                ...
                if (5 !== i.sizeType) {
                    var n = e.pdb_deliv, o = e.rtb_deliv, r = e.order_deliv;
            ...
            getPmpRequestUrl: function (t) {
                ...
                var s = t.timestampWatcher, a = s.t1, d = s.t2, l = s.t3, c = t.response;
                if (c) {
                    var h = c.placement.container;
                    i.qn = c.queryid, t.paramObj.qn = c.queryid;
                    var u = t.width, p = t.height;
                    u > 0 && p > 0 && (i.sz && (i.sz = ""), n.push("sz=" + u + "x" + p)), (t.pcwd || 5 === h.sizeType) && n.push("conwid=" + u), (t.pchd || 5 === h.sizeType) && n.push("conhei=" + p);
                    var m = c.pdb_deliv;
                    m.deliv_id && n.push("pdbid=" + m.deliv_id), c.media_protect && n.push("mpdi=" + c.media_protect);
                    var f = c.order_deliv;
                    f.deliv_id && n.push("orderid=" + f.deliv_id), f.demand_id && n.push("odid=" + f.demand_id);
                    var g = c.rtb_deliv;
                    g.deliv_id && n.push("rtbid=" + g.deliv_id), g.demand_id && n.push("rdid=" + g.demand_id);
                    var y = c.placement.complement_type;
                    if (t.isNeedCacheRequest || 4 === y || 7 === y) {
                        var v = i.qn;
                        i.dpv = v, t.paramObj.dpv = v, this.requestCache.add(v, t)
                    }
                    this.config.EXP_SATUS && 0 === t.id.indexOf("u") ? n.push("dc=3") : n.push("dc=2"), s && a > 0 && (i.tt = a + "." + (d - a) + "." + (l - a) + "." + (+new Date - a)), i.exps && (n.push("exps=" + i.exps), i.exps = "")
                }
                var w = n.join("&");
                return e = t.posUrl && this.browser.antBrowser ? t.posUrl + w + "&" + this.getParamString(i) : this.config.POS_URL + w + "&" + this.getParamString(i)
            }
        }), i.define({
            name: "slot",
            namespace: "dup.business",
            ...
            adSlotFinish: function (t) {
                ...
                if (n.response) {
                    ...
                    for (var r in this.origentation.watchingSlotsMap)if (r && this.origentation.watchingSlotsMap.hasOwnProperty(r) && this.origentation.watchingSlotsMap[r] && 0 === ("" + t).indexOf("" + r) && n.response) {
                        var s = o.deliv_des, a = s.width || 0, d = s.height || 0;
            ...
            requestSlotInfo: function (t) {
                !this.config.FIRST_ONCESEACH && this.config.EXP_SATUS && (this.config.FIRST_ONCESEACH = !0, this.dom.bind(window, "message", i.proxy(this, this.onMessageHandler)));
                var e = !1;
                ...
                var n, o;
                t.posUrl && this.browser.antBrowser ? (t.paramObj.ctxant = "1", t.paramObj.pcn = t.pcn, n = this.param.getParamString(t.paramObj), o = t.posUrl + n) : (n = this.param.getParamString(t.paramObj), o = this.config.POS_URL + n), t.paramObj.dtm = this.config.HTML_POST, t.timestampWatcher.t2 = +new Date;
                var r = !1;
                "union" === t.productLine && (r = !0), t.isAsync === !0 && (r = !0), e = this.config.EXP_SATUS ? this.reqLocalInfo(t) : this.localAdInfo(t), e ? (this.setStatus(t.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](e)) : (this.sendJsonpRequest(o, r), this.setStatus(t.id, this.config.STATUS_REQUEST))
            },
            ...
            localAdInfo: function (t) {
                try {
                    ...
                    var i = (new Date).getTime(), n = i - e.adExpire;
            ...
            checkFail: function () {
                ...
                for (var e in t)if (e && t.hasOwnProperty(e) && t[e]) {
                    ...
                    var r = i.status, s = i.errors || [], a = decodeURIComponent(s.join(","));
                    a && this.sendLog({
                        type: "hlog",
            ...
            regisetViewWatch: function (t) {
                ...
                var e = this.dom.g(t.containerId);
                if (e) {
                    var i = t.paramObj, n = t.width, o = t.height, r = "";
                    if (t.response) {
                        var s = t.response.placement, a = s.container;
            ...
            initializeEvent: function () {
                this.windowOnLoadHandler(), this.dom.ready(i.proxy(this, this.windowOnLoadDelay), 2e3), this.dom.bind(this.win, "beforeunload", i.proxy(this, this.windowOnUnloadHandler))
            },
            ...
            windowOnLoadHandler: function (t) {
                this.intervalStatus = this.STATUS.LOAD, this.registerFocusEvent(this.win), (!this.browser.ie || this.browser.ie && this.browser.ie > 6) && this.viewOnChange(), this.intervalId = setInterval(i.proxy(this, this.viewOnChange), this.intervalTimeSpan)
            },
            ...
            windowOnUnloadHandler: function (t) {
                try {
                    ...
                    if (t) {
                        ...
                        if (this.browser.ie)for (o = s + r; o > s;)s = (new Date).getTime(); else {
            ...
            registerFocusEvent: function (t) {
                var t = t || this.win;
                this.winFocused = !0, this.browser.ie ? (this.dom.bind(t, "focusin", i.proxy(this, this.allDomOnFocusHandler)), this.dom.bind(t, "focusout", i.proxy(this, this.allDomOnBlurHandler))) : (this.dom.bind(t, "focus", i.proxy(this, this.allDomOnFocusHandler)), this.dom.bind(t, "blur", i.proxy(this, this.allDomOnBlurHandler)))
            },
                ...
                for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
                    ...
                    if (n.hasOwnProperty("id")) {
                        ...
                        if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
                                ...
                                productLine: "adcodex",
                                isAsync: o
                            }), n.hasOwnProperty("pos") && (t.posUrl = this.config.HTTP_PROTOCOL + "//" + n.pos + "/s?", t.pcn = n.pos), this.additionalParam.paramCheck(t, n), t.containerId = n.container || t.containerId, t.display = n.display, t.rpdn = n.rpdn || "", t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
                            var r, s = n.size;
                            if (s && s.indexOf(":") > -1) {
                                r = s.split(":");
            ...
            expand2Left: function (t, e, i, n, o, r) {
                ...
                var s = e.getElementsByTagName("iframe")[0], a = parseInt(this.getComputedWidth(e));
            ...
            processFrameData: function (t) {
                ...
                var d = t.width || n && n.width, l = t.height || n && n.height, c = this.creativePreview.getPreviewUrl(d, l, r, t.displayType || "inlay");
                if (c)e = c; else if (t.isPdbAd) {
                    var h = this.config.DUP_PREFIX + "renderFrame";
                    this.data.defineOnce(h, i.proxy(this, this.renderFrame)), e = this.getFrameUrl(), o = 'onload="' + h + "('" + t.id + "', this);\""
                } else if (t.isNeedCacheRequest) {
                    var u = this.config.DUP_PREFIX + "cacheRequest", p = "adsbybaidu_callback";
                    this.data.defineOnce(p, i.proxy(this, this.cacheRequestCallback)), this.data.defineOnce(u, i.proxy(this.requestCache, this.requestCache.cacheRequest)), e = this.param.getPmpRequestUrl(t), o = 'onload="' + u + "('" + t.paramObj.dpv + "', this);\""
                } else e = this.param.getPmpRequestUrl(t);
                var m = {};
                return m.iframeId = t.iframeId, m.srcAttriName = "src", m.onloadDefine = o, m.iframeWidth = "" + d, m.iframeHeight = "" + l, m.url = e, m
            },
            ...
            evalScript: function (t, e) {
                try {
                    ...
                    this.log.monitorLog({error: "createscripterror", status: "renderFail"})
                }
            },
            render: function (t, e) {
                try {
            ...
            createContainerElementByInfo: function (t) {
                ...
                if (1 === t.followType) {
                    ...
                    var o = this.getVerticalStyle(t), r = this.getHorizontalStyle(t);
            ...
            updatePosition: function (t, e) {
                var i = this.dom.g(e);
                if (i) {
                    var n = i.style, o = "CSS1Compat" !== document.compatMode, r = document.body ? document.body : document.documentElement, s = o ? r : document.documentElement, a = (s.clientWidth, s.clientHeight), d = (window.pageXOffset || s.scrollLeft, window.pageYOffset || s.scrollTop);
            ...
            registEvent: function (t) {
                ...
                this.dom.bind(n, "click", i.proxy(this, this.closeBtnOnClickHandler)), this.dom.bind(n, "mouseover", i.proxy(this, this.closeBtnOnMouseOverHandler)), this.dom.bind(n, "mouseout", i.proxy(this, this.closeBtnOnMouseOutHandler))
            },
            closeBtnOnClickHandler: function () {
            ...
            render: function (t, e) {
                if (this.validate(t)) {
                    this.info = t;
                    var n = this.createCloseElement(t), o = this.createBlockHtmlTemplate(t), r = {
                        width: t.width,
                        height: t.height,
                        iframe: this.frame.getFrameHTML(e),
                        closeBtn: n
                    }, s = this.createContainerElementByInfo(t);
                    s.innerHTML = this.lang.template(o, r), this.dom.g(t.domId) || document.body.insertBefore(s, document.body.firstChild), this.registEvent(t);
                    var a = t.closeTime || 0;
            ...
            processSlotInfo: function (t) {
                ...
                e.sizeType = o;
                var m = t.styleOpenApi, f = m.cpro_w || m.rsi0 || 0, g = m.cpro_h || m.rsi1 || 0;
            ...
            validate: function (t) {
                var e = "bd_close_" + this.id, i = this.cookie.get(e, window);
            ...
            render: function (t) {
                ...
                if (this.validate(e)) {
                    ...
                    if (!n) {
                        ...
                        if (o) {
                            this.decorateContainer(o, e), t.width = e.width, t.height = e.height;
                            ...
                            c && this.dom.bind(c, "click", i.proxy(this, this.closeBtnOnClickHandler, t)), this.hiddenFloatAd.render(t), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH)
                        }
                    }
                }
            }
            ...
            render: function (t) {
                if (this.validate(t)) {
                    ...
                    if (!e) {
                        var n = [];
                        n.push(t);
                        var o = t.response.placement, r = o.container, s = parseInt(r.location || 0, 10);
                        if (6 === s) {
                            n = [];
                        ...
                        for (var l = 0, c = n.length; c > l; l++) {
                            var h = n[l], u = i.create(this.floatBlock);
            ...
            callback: function (t) {
                try {
                    ...
                    var n = this.painterSelector.getPainter(e), o = i.using(n);
                    o ? o.render(e) : n && this.loader.load(e.id, n, i.proxy(this, this.painterLoadedCallback, n, e))
                } catch (r) {
                    var s = encodeURIComponent(r), a = {type: "elog", pos: "callback", id: t.tuid, mes: s};
