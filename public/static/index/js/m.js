try {
    window._ssp_global = window._ssp_global || {}, function (t) {
        ...
        t.setPath("https://dup.baidustatic.com/"), t.define({
            ...
            load: function (e, i, n) {
                var o = t.getClassPath(i), r = this.check(o);
                if (!r) {
            ...
            getQueryURI: function (t) {
                for (var e = [], i = 0; t > i; i++) {
                    var n = String.fromCharCode(Math.floor(26 * Math.random()) + "a".charCodeAt(0)), o = /^[a-z]+$/g;
                    o.test(n) && e.push(n)
                }
                return e
            }
            ...
            $sceneTactics: function () {
                ...
                this.config.REQUEST_URL_CNAME && this.replaceDomain(), this.config.POS_URL || (this.config.POS_URL = this.config.HTTP_PROTOCOL + this.config.REQUEST_URL + this.QueryURI[0] + "c" + this.QueryURI[1] + "m?"), this.config.EXP_SWITCH && this.exp.tactics()
            },
            sceneTactics: function () {
            },
            ...
            paramsList: [{
                ...
                key: "ps", value: function () {
                    var t = this.dom.g(this.slotInfo.containerId), e = this.style.getPosition(t);
            ...
            paramsList: [{
                ...
                key: "tpr", value: function () {
                    ...
                    var e, i, n = 24e4, o = (new Date).getTime();
            ...
            getPmpRequestUrl: function (t) {
                ...
                var w = n.join("&");
                return e = t.posUrl && (this.browser.uc || this.browser.tencent) ? t.posUrl + w + "&" + this.getParamString(i) : this.config.POS_URL + w + "&" + this.getParamString(i)
            }
        }), t.define({
            name: "slot",
            namespace: "dup.business",
            ...
            createSlot: function (t) {
                ...
                var n = {};
                return n.index = this.slotIdCountMap[i]++, n.count = ++this.slotCount, n.id = i + "_" + n.index, n.containerId = this.config.DUP_PREFIX + "_wrapper_" + i + "_" + n.index, n.slotId = t.slotId, n.productLine = t.productLine, n.errors = [], n.isAsync = t.isAsync,
                    this.setStatus(n.id, this.config.STATUS_CREATE), e ? n.timestampWatcher = {t1: e} : n.timestampWatcher = {t1: 0}, window.cproStyleApi ? n.styleOpenApi = window.cproStyleApi[i] || {} : n.styleOpenApi = {}, 0 === i.indexOf("u") && (n.productLine = "union", n.width = n.styleOpenApi.cpro_w || n.styleOpenApi.rsi0 || 0, n.height = n.styleOpenApi.cpro_h || n.styleOpenApi.rsi1 || 0), n
            },
            ...
            requestSlotInfo: function (e) {
                !this.config.FIRST_ONCESEACH && this.config.EXP_SATUS && (this.config.FIRST_ONCESEACH = !0, this.dom.bind(window, "message", t.proxy(this, this.onMessageHandler)));
                var i = !1;
                e.paramObj = this.param.getParamObj(e), e.paramObj.exps = this.config.EXP_ID, e.paramObj.pcn = this.config.IS_CNAME ? this.config.REQUEST_URL_CNAME : "";
                var n, o;
                e.posUrl && (this.browser.uc || this.browser.tencent) ? (e.paramObj.ctxant = "1", e.paramObj.pcn = e.pcn, n = this.param.getParamString(e.paramObj), o = e.posUrl + n) : (n = this.param.getParamString(e.paramObj), o = this.config.POS_URL + n), e.paramObj.dtm = this.config.HTML_POST, e.timestampWatcher.t2 = +new Date;
                var r = !1;
                "union" === e.productLine && (r = !0), e.isAsync === !0 && (r = !0), i = this.config.EXP_SATUS ? this.reqLocalInfo(e) : this.localAdInfo(e), i ? (this.setStatus(e.id, this.config.STATUS_REQUEST), window[this.config.LOADER_DEFINE_NAME](i)) : (this.sendJsonpRequest(o, r), this.setStatus(e.id, this.config.STATUS_REQUEST))
            },
            ...
            updateInfo: function (t) {
                ...
                this.storageSlotInfo = this.storage.getItem(t.tuid), this.storageSlotInfo && (e = this.lang.jsonToObj(this.storageSlotInfo), this.storage.isAvailable && window.JSON && window.JSON.stringify && e && e.placement && e.placement.update && e.placement.update !== i && (t.adExpire = (new Date).getTime(), t.rewrite = !0, this.storage.setItem(t.tuid, JSON.stringify(t))))
            },
            ...
            localAdInfo: function (t) {
                try {
                    ...
                    return n > this.config.STORAGE_TIMER || !e.rewrite ? (this.storage.removeItem(t.id), !1) : e
                } catch (o) {
                }
            },
            ...
            cacheRequestCallback: function (e) {
                ...
                if ("success" !== i) {
                    var n = this.requestCache.get(e.dpv), o = n.response.pdb_deliv.deliv_des;
                    o = o._html;
            ...
            registEvent: function (e) {
                var i = e.domId + "_closebtn", n = this.dom.g(i);
            ...
            render: function (e, i) {
                if (this.validate(e)) {
                    this.info = e;
                    var n = this.createCloseElement(e), o = this.createBlockHtmlTemplate(e), r = {
                        width: e.width,
                        height: e.height,
                        iframe: this.frame.getFrameHTML(i),
                        closeBtn: n
            ...
            render: function (e) {
                if (this.validate(e)) {
                    ...
                    if (!i) {
                        var n = [];
                        n.push(e);
                        var o = e.response.placement, r = o.container, s = parseInt(r.location || 0, 10);
                        if (6 === s) {
                            n = [];
                            var a = this.slot.cloneSlot(e), d = this.slot.cloneSlot(e);
                        ...
                        for (var l = 0, c = n.length; c > l; l++) {
                            var h = n[l], u = t.create(this.floatBlock);
            ...
            callback: function (e) {
                try {
                    ...
                    i.response = e, this.slot.setStatus(i.id, this.config.STATUS_RESPONSE), this.slot.processSlot(i), i.timestampWatcher.t3 = (new Date).getTime(), this.slot.adInfoStorage(i), this.param.processExtendsParam(i);
                    var n = this.painterSelector.getPainter(i), o = t.using(n);
                    o ? o.render(i) : n && this.loader.load(i.id, n, t.proxy(this, this.painterLoadedCallback, n, i))
                } catch (r) {
                    var s = encodeURIComponent(r), a = {type: "elog", pos: "callback", id: e.tuid, mes: s};
